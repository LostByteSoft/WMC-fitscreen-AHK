...
taskkill /f /im "wmc_minimize.exe"
@echo ----------------------------------------------------------
...
copy "WMC fitscreen.lnk" "%appdata%\Microsoft\Windows\Start Menu\Programs\Startup\"
@echo ----------------------------------------------------------

@echo Copy an *.ini file is not necessary an default ini is not copied
